...
describe("UbeswapPool", () => {
  ...
  let pool0: MockTimeUbeswapPool;
  let pool1: MockTimeUbeswapPool;
  ...
  let swapTargetCallee: TestUbeswapCallee;
  let swapTargetRouter: TestUbeswapRouter;
  ...
  beforeEach("deploy first fixture", async () => {
    ...
    ): Promise<[MockTimeUbeswapPool, any]> => {
