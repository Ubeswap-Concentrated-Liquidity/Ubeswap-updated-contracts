...
import type { IUbeswapPoolState } from "../IUbeswapPoolState";

export class IUbeswapPoolState__factory {
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IUbeswapPoolState {
    return new Contract(address, _abi, signerOrProvider) as IUbeswapPoolState;
  }
}
