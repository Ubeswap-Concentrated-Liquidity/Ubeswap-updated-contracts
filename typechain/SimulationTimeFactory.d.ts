...
interface SimulationTimeFactoryInterface extends ethers.utils.Interface {
  functions: {
    "baseFeeConfiguration()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "baseFeeConfiguration",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export class SimulationTimeFactory extends Contract {
  ...
  interface: SimulationTimeFactoryInterface;
  ...
  estimateGas: {
    baseFeeConfiguration(overrides?: CallOverrides): Promise<BigNumber>;
