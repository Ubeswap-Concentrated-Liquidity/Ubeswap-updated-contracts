...
interface MockTimeUbeswapPoolInterface extends ethers.utils.Interface {
  functions: {
    ...
    "getAverages()": FunctionFragment;
    "getFee()": FunctionFragment;
    "getInnerCumulatives(int24,int24)": FunctionFragment;
    "getKeyForPosition(address,int24,int24)": FunctionFragment;
    "getPrevTick()": FunctionFragment;
    ...
    "setTotalFeeGrowth0Token(uint256)": FunctionFragment;
    "setTotalFeeGrowth1Token(uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "getKeyForPosition",
    values: [string, BigNumberish, BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "getPrevTick",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setTotalFeeGrowth0Token",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "setTotalFeeGrowth1Token",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
...
export class MockTimeUbeswapPool extends Contract {
  ...
  interface: MockTimeUbeswapPoolInterface;
  ...
  functions: {
    ...
    checkBlockTimestamp(overrides?: CallOverrides): Promise<[boolean]>;
    ...
    getFee(overrides?: CallOverrides): Promise<[number] & { fee: number }>;
    ...
    "getKeyForPosition(address,int24,int24)"(
      owner: string,
      bottomTick: BigNumberish,
      topTick: BigNumberish,
      overrides?: CallOverrides
    ...
    getPrevTick(
      overrides?: CallOverrides
    ): Promise<[number, number] & { tick: number; currentTick: number }>;
    ...
    setTotalFeeGrowth0Token(
      _totalFeeGrowth0Token: BigNumberish,
      overrides?: Overrides
    ): Promise<ContractTransaction>;

    "setTotalFeeGrowth0Token(uint256)"(
      _totalFeeGrowth0Token: BigNumberish,
      overrides?: Overrides
    ): Promise<ContractTransaction>;

    setTotalFeeGrowth1Token(
      _totalFeeGrowth1Token: BigNumberish,
      overrides?: Overrides
    ): Promise<ContractTransaction>;

    "setTotalFeeGrowth1Token(uint256)"(
      _totalFeeGrowth1Token: BigNumberish,
      overrides?: Overrides
    ): Promise<ContractTransaction>;
  ...
  estimateGas: {
    ...
    getAverages(overrides?: CallOverrides): Promise<BigNumber>;
    ...
    getPrevTick(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    getAverages(overrides?: CallOverrides): Promise<PopulatedTransaction>;
    ...
    getPrevTick(overrides?: CallOverrides): Promise<PopulatedTransaction>;
