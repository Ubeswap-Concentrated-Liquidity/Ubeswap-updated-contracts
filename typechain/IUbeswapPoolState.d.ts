...
interface IUbeswapPoolStateInterface extends ethers.utils.Interface {
  functions: {
...
export class IUbeswapPoolState extends Contract {
  ...
  interface: IUbeswapPoolStateInterface;
