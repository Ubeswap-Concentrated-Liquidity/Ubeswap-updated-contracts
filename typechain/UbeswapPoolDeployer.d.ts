...
interface UbeswapPoolDeployerInterface extends ethers.utils.Interface {
  functions: {
...
export class UbeswapPoolDeployer extends Contract {
  ...
  interface: UbeswapPoolDeployerInterface;
