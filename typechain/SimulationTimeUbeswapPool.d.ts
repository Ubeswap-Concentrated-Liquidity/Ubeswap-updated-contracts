...
interface SimulationTimeUbeswapPoolInterface extends ethers.utils.Interface {
  functions: {
...
export class SimulationTimeUbeswapPool extends Contract {
  ...
  interface: SimulationTimeUbeswapPoolInterface;
