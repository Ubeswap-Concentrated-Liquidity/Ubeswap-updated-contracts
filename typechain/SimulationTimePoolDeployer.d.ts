...
interface SimulationTimePoolDeployerInterface extends ethers.utils.Interface {
  functions: {
...
export class SimulationTimePoolDeployer extends Contract {
  ...
  interface: SimulationTimePoolDeployerInterface;
  ...
  estimateGas: {
    ...
    setFactory(_factory: string, overrides?: Overrides): Promise<BigNumber>;
